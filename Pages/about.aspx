...
<h1>QA Cinema Ltd</h1>
      ...
      <div class="container">
        <ul class="list-group">
            <li class="list-group-item">Liam Roberts- <b>Scrum Master</b> 
                <br />
                <b>Email:</b> Liam.Roberts@qa.com</li>
            <br />
            <li class="list-group-item">Timothy Loukas- <b>Product Owner</b> 
                <br />
                <b>Email:</b> Timothy.Loukas@qa.com</li>
            <br />
            <li class="list-group-item">
                <h3>Development team members</h3>
                Tho Thai
                <br />
                <b>Email:</b> Tho.Thai@qa.com
                <br />
                <br />
                Alex Rimmer
                <br />
                <b>Email:</b> Alex.Rimmer@qa.com
                <br />
                <br />
                Ivo Tabandzhov
                <br />
                <b>Email:</b> Ivo.Tabandzhov@qa.com
                <br />
                <br />
                Nafi Sifat
                <br />
                <b>Email:</b> Nafi.Sifat@qa.com<
                <br />
                <br />
                Dannish Hussain 
                <br />
                <b>Email:</b> Dannish.Hussain@qa.com
                <br />
                <br />
                Spiros Pasparakis
                <br />
               <b>Email:</b> Spiros.Pasparakis@qa.com
                </li>
        </ul>
	...
	<div class="row">
		...
		<div class="col-md-4">
			...
			<ul>
				...
				<li><a href="./Scrum_Information">Scrum</a></li>
			</ul>
		</div>
